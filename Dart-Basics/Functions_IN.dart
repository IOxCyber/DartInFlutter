...
print('---Calling Optional Default Parameter Function---\n');
optDefaultParam(10);
optDefaultParam(10,r:20);
optDefaultParam(10,s:30);
...
//-------{O P T I O N A L _ N A M E D}--------
optNamedParam(m,{n,o}){
print("1st Parameter is : ${m} \n 2nd Parameter is : ${n} \n 3rd Parameter is : ${o}");  
}

//-------{O P T I O N A L _ D E F A U L T _ V A L U E}
optDefaultParam(q,{r=50,s}){ //here r will have its value 50 by default
print("1st Parameter is : ${q} \n 2nd Parameter is : ${r} \n 3rd Parameter is : ${s}");  
}
