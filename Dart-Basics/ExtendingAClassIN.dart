class Product{
  ...
  Product(this._name, this._price, this._expDate);//underScore (_) is used for making private variable. 
...
int main() {
  var drink = Beverage("Minute Maid", 90.45, "01/01/2020", 1.75, "Orange Juice");
